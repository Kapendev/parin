...
bool update(float dt) {
    ...
    auto viewportCenter = viewport.size * 0.5;
    auto viewportMousePosition = mouse - Rect(resolution * 0.5, viewport.size).centerArea.position;
    ...
    drawViewport(viewport, resolution * 0.5, DrawOptions(Hook.center));
